...
<body>
    ...
    <div class="main">
       <a href="./ajout_salles.php" class='btn btn-primary'>Ajouter</a><br><br>
       <table class='table table-striped'>
            ...
            <?php
                ...
                <tr>
                    ...
                    <td><a class="btn btn-success btn-sm" href='modifier_salles.php?id=<?php echo $row['id']; ?>'>Modifier</a> <a class="btn btn-danger btn-sm" href='delete_salles.php?id=<?php echo $row['id']; ?>'>Supprimer</a></td>
                </tr>
                <?php
		            }
                }
