<?php
    ...
    if(!empty($_POST["add_profs"])) {
	
	$sql = "INSERT INTO professeurs ( firstname, lastname, level ) VALUES ( :firstname, :lastname, :level )";
    ...
    <div class="main">
        <div class="row">
            ...
            <form name="frmAdd" action="" method="POST">
                ...
                <br>
                <div class="demo-form-row">
                    <input name="add_profs" type="submit" value="Ajouter" class="btn btn-primary">
                </div>
            </form>
            </div>
            <div class="col-6"></div>
